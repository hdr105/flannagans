...
if(isset($_FILES['upload']) && strlen($_FILES['upload']['name']) >1) {
  ...
  $site = $protocol. $_SERVER['SERVER_NAME'] .dirname($_SERVER['PHP_SELF']).'/';
  ...
  $f_name = setFName( str_replace('\\','/',__DIR__).'/'. $upload_dir, F_NAME, ".$type", 0);
  $uploadpath =  str_replace('\\','/',__DIR__) .'/'. $upload_dir . $f_name;  // full file path
