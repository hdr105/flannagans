var ScrudCForm = {
    ...
    buildOptions:function(field){
        ...
        var lbl = $('<input type="text" class="form-control" placeholder="Type something…" value="'+ScrudCForm.elements[field].label+'" />');
        lbl.keyup(function(){
    ...
    addBlockToForm:function(){
         var block = $('<div class="portlet green-sharp box"></div>').append($('<div class="portlet-title">Great</div>')).append($('<div class="portlet-body dragableArea">Hello</div>'));
    ...
    addFieldToForm:function(field,pType){
        ...
        var lbl = $('<label class="control-label col-md-3">'+
            ''+ScrudCForm.elements[field].label+'  <span id="preview_error_field_'+field+'" style="color:red;display:none;">*</span></label>');
        ...
        switch (ScrudCForm.elements[field].type){
            case 'text':
                ctl = $('<input type="text" class="form-control" />').width(ScrudCForm.elements[field].type_options.size); // for
                // text
                break;
            case 'password':
                ctl = $('<input type="password" class="form-control" />').width(ScrudCForm.elements[field].type_options.size);
                break;
            case 'date':
        ...
        var li = $('<div id="preview_field_'+field+'" class="row"></div>');
    ...
    changeFieldToForm:function(field){
        ...
        switch (ScrudCForm.elements[field].type){
            case 'text':
                $('#preview_field_'+field).find('.controls').append($('<input type="text" class="form-control" />').width(ScrudCForm.elements[field].type_options.size));
                break;
            case 'password':
                $('#preview_field_'+field).find('.controls').append($('<input type="password" class="form-control" />').width(ScrudCForm.elements[field].type_options.size));
                break;
            case 'date':
    ...
    buildPreviews:function(){
        ...
        for(var i in ScrudCForm.config.ids){
        	if (fields[ScrudCForm.config.ids[i]] != undefined){
...
$(document).ready(function(){
    ...
    $('#btn_section_blcok').click(function(){
        ScrudCForm.addBlockToForm();
    });
