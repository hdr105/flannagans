...
class Reports extends Admin_Controller 
{
    ...
    public function genPDF($rid='' , $pdf_type='D') 
    {
                ...
                if(preg_match("/".$tables[0]."/", $cf1[1] ))
                {
                    if (isset($cf1[1]) && !empty($cf1[1])) 
                    {
                        ...
                        if($cfn[2]=='date'){
                            ...
                            {
                                $dates = explode(' ', $cf1[3]);
                                $date_1 = date('Y-m-d',strtotime($dates[0]));
                                $date_2 = date('Y-m-d',strtotime($dates[1]));
                            }
                            else
                            {
                                $cf1[3]=date('Y-m-d',strtotime($cf1[3]));
                            }
                        }
                        ...
                        switch (strtolower($cf1[2])) {
                            case 'e':
                                $conditions .= " {$cfn[0]} = '{$cf1[3]}' ";
                                break;
                             case 'n':
                                $conditions .= " {$cfn[0]} <> '{$cf1[3]}' ";
                                break;
                             case 's':
                                $conditions .= " {$cfn[0]} LIKE '{$cf1[3]}%'  ";
                                $a[] = $cf1[1];
                                $a[] = $conditions;
                                break;
                             case 'ew':
                             ...
                             case 'c':
                                ...
                                break;
                             case 'k':
                                $conditions .= " {$cfn[0]} NOT LIKE '%{$cf1[3]}%' ";
                                break;
                             case 'y':
                                $conditions .= " {$cfn[0]} IS NULL ";
                                break;
                            case 'ny':
                                $conditions .= " {$cfn[0]} IS NOT NULL ";
                                break;             
                            case 'bw':
                                $conditions .= " ({$cfn[0]} BETWEEN {$date_1} AND {$date_2})";
                                break;             
                            case 'b':
                                $conditions .= " {$cfn[0]} < {$cf1[3]} ";
                                break;             
                            case 'a':
                                ...
                                break;
                            case 1:
                                $conditions .= "YEAR(".$cfn[0].") = YEAR(NOW()) AND MONTH(".$cfn[0].")=MONTH(NOW()) ";
                                break;

                            case 2:
                                $conditions .= "WEEKOFYEAR(".$cfn[0].") = WEEKOFYEAR(NOW()) ";
                                break;

                            case 3:
                                $conditions .= "YEAR(".$cfn[0].") = YEAR(NOW()) AND MONTH(".$cfn[0].") = MONTH(NOW()) AND DAY(".$cfn[0].") = DAY(NOW()) ";
                                break;

                            case 4:
                                $conditions .= "WEEKOFYEAR(".$cfn[0].")=WEEKOFYEAR(NOW())-1 ";
                                break;

                            case 5:
                                $conditions .= "YEAR(".$cfn[0].") = YEAR(NOW()) ";
                                break;

                            case 6:
                                $conditions .= "YEAR(".$cfn[0].") = YEAR(NOW())-1 ";
                                break;          
                            default: 
                                break;
                        }
                    ...
                    foreach ($tables as $tabkey => $tabvalue)  
                    {
                        if(preg_match("/".$tabvalue."/", $cf1[1] ))
                        {
                            if (isset($cf1[1]) && !empty($cf1[1])) 
                            {
                                ...
                                switch (strtolower($cf1[2])) {
                                    case 'e':
                                        $rm_cond_str .= " {$cfn[0]} = '{$cf1[3]}' ";
                                        break;
                                     case 'n':
                                        $rm_cond_str .= " {$cfn[0]} <> '{$cf1[3]}' ";
                                        break;
                                     case 's':
                                        $rm_cond_str .= " {$cfn[0]} LIKE '{$cf1[3]}%'  ";
                                        $a[] = $cf1[1];
                                        $a[] = $conditions;
                                        break;
                                     case 'ew':
                                     ...
                                     case 'c':
                                        ...
                                        break;
                                     case 'k':
                                        $rm_cond_str .= " {$cfn[0]} NOT LIKE '%{$cf1[3]}%' ";
                                        break;
                                     case 'y':
                                        $rm_cond_str .= " {$cfn[0]} IS NULL ";
                                        break;
                                    case 'ny':
                                        $rm_cond_str .= " {$cfn[0]} IS NOT NULL ";
                                        break;             
                                    case 'bw':
                                        $rm_cond_str .= " ({$cfn[0]} BETWEEN {$date_1} AND {$date_2})";
                                        break;             
                                    case 'b':
                                        $rm_cond_str .= " {$cfn[0]} < {$cf1[3]} ";
                                        break;             
                                    case 'a':
                                        ...
                                        break;
                                    case 1:
                                        $rm_cond_str .= "YEAR(".$cfn[0].") = YEAR(NOW()) AND MONTH(".$cfn[0].")=MONTH(NOW()) ";
                                        break;

                                    case 2:
                                        $rm_cond_str .= "WEEKOFYEAR(".$cfn[0].") = WEEKOFYEAR(NOW()) ";
                                        break;

                                    case 3:
                                        $rm_cond_str .= "YEAR(".$cfn[0].") = YEAR(NOW()) AND MONTH(".$cfn[0].") = MONTH(NOW()) AND DAY(".$cfn[0].") = DAY(NOW()) ";
                                        break;

                                    case 4:
                                        $rm_cond_str .= "WEEKOFYEAR(".$cfn[0].")=WEEKOFYEAR(NOW())-1 ";
                                        break;

                                    case 5:
                                        $rm_cond_str .= "YEAR(".$cfn[0].") = YEAR(NOW()) ";
                                        break;

                                    case 6:
                                        $rm_cond_str .= "YEAR(".$cfn[0].") = YEAR(NOW())-1 ";
                                        break;            
                                    default:
                                        break;
                                }
...
////////////////////  CUSTOM CONDITION START /////////////////////////
        ...
        $cst_data = explode(',',$rq['custom_condition']);
        $sql .= $cst_data[0]." ".$cst_data[1];
        // $cst_opt = array();
...
//////////// GET TOTAL NUMBER OF RECORDS START /////////////////////////////
...
//////////// LIMIT ON RECORDS END /////////////////////////////////////
        ...
        $var['sql'] = $sql;
        $var['fields_lbs'] = $fld_names_for_header ;
                ...
                if(in_array($ddkey,$rltd_names))          
                {
                    ...
                    if( $ddvalue != "" )
                    {
                        ...
                        foreach ($explode_ids as $exp_key => $exp_value) 
                        {
                            ...
                            // }
                            if(isset($rm_cond_data[$tables[$ddkey]]) && !empty($rm_cond_data[$tables[$ddkey]]) )
                            {
                                $rsql .= " ".implode('', $rm_cond_data[$tables[$ddkey]]);
                            }
                            if(isset($rm_groupby_cond[$tables[$ddkey]]) && !empty($rm_groupby_cond[$tables[$ddkey]]))
                            {
                                $rsql .= " GROUP BY ".implode(',', $rm_groupby_cond[$tables[$ddkey]]);
                            }
                            if(isset($rm_orderby_cond[$tables[$ddkey]]) && !empty($rm_orderby_cond[$tables[$ddkey]]))
                            {
...
/////////////////// CONVERT IDS INTO NAME ETC START //////////////////////
        foreach ($myData as $mykey => $myvalue) {
            foreach ($myvalue as $mkey => $mvalue) {
                ...
                {
                    if (array_key_exists('option_table', $auto_fields[$tables[0]."__".$mkey])) 
                    {    
                ...
                else if (is_array($mvalue) )
                {
                    foreach ($mvalue as $rekey => $revalue) {
                        ...
                        foreach ($revalue as $rkey => $rvalue) {
                            ...
                            {
                                if (array_key_exists('option_table', $auto_fields[$tables[$mkey]."__".$rkey]) ) 
                                {
                                    $id =  $rvalue;
                                    ...
                                    if ($auto_fields[$tables[$mkey]."__".$rkey]['option_table'] == 'contact') 
                                    {
                                        $vv = ucwords($rdata['First_Name']) . ' ' . ucwords($rdata['Last_Name']);
...
////////////////// CONVERT IDS INTO NAME ETC END ////////////////////////
        ...
        if (file_exists($pdfFilePath) == FALSE)
        {
            ...
            $html = $var['main_content'];
            $this->load->library('m_pdf');
            header('Content-Type: application/pdf');
            $this->m_pdf->pdf->WriteHTML($var['main_content'] );
            $this->m_pdf->pdf->Output($file_name, $pdf_type);
        }
