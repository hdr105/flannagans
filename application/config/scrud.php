...
$config['senserve_systme_name'] = '1.0';
...
$config['fileExtensions'] = array(".png", ".jpg", ".gif",".doc",".docx",".xls",".xlsx",".zip",".rar",".7z",".pdf");
...
define('__DATE_FORMAT_TIME__', 'd/m/Y H:i:s'); // MM/dd/yyyy | dd/MM/yyyy | MM-dd-yyyy | dd-MM-yyyy

define('__DB_DATE_FORMAT__', 'yyyy-mm-dd');
$date_format_convert['yyyy-mm-dd'] = 'Y-m-d';
