...
$conf = array (
		...
		array (
				...
				array (
						...
						'format' => '<a type="button" onclick="__view(\'{ppri}\'); return false;" class="btn btn-sm">'.$this->lang->line('view').'</a> <a type="button" onclick="__edit(\'{ppri}\'); return false;" class="btn btn-sm btn-info">'.$this->lang->line('edit').'</a> <a type="button" onclick="__delete(\'{ppri}\'); return false;" class="btn btn-sm btn-danger">'.$this->lang->line('delete').'</a>',
						'width' => '250',
						'align' => 'center',
				),
		),
