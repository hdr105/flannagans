...
<div style="height: 52px;">
    <div data-spy="affix" data-offset-top="54" style="
        ...
        <div class="container" style="border-bottom: 1px solid #CCC; padding-bottom:5px;padding-top:5px;
            ...
            <div class="btn-group">
                <a class="btn" onclick="searchModal();"><i class="icon-search"></i> <?php echo $CI->lang->line('search');?></a>
                <?php
		        $q = $this->queryString;
		        if (isset($q['xtype']))
		            unset($q['xtype']);
                ...
                <?php if (!empty($this->results)) { ?>
                    <a class="btn"  onclick="crudExport();"><i class="icon-download"></i> <?php echo $CI->lang->line('export_csv');?></a>
                <?php } else { ?>
                    <a class="btn disabled"><i class="icon-download"></i> <?php echo $CI->lang->line('export_csv');?></a>
                <?php } ?>
                <a class="btn"  onclick="crudExportAll();"><i class="icon-download"></i> <?php echo $CI->lang->line('export_csv_all');?></a>
                <a type="button" class="btn btn-info" onclick="newRecord();"> <i class="icon-plus icon-white"></i> <?php echo $CI->lang->line('add'); ?></a>
            </div>
        </div>
    </div>
    </div>
            ...
            <div style="overflow: auto;">
                <table class="table table-bordered table-hover list table-condensed table-striped">
                    ...
                    <tbody>
                        ...
                        <?php } else { ?>
                            <tr>
                                <td colspan="<?php echo count($fields); ?>"><?php echo $CI->lang->line('no_data_to_display');?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
