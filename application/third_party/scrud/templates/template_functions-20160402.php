    ...
    if(isset($_GET['key'])){
        ...
        $explo = explode(',',$entry_data[0]['eventsfor']);
            ...
            if($field == $name){
                ...
                <div class="row">
                        <div class="col1">
                            <div class="input-group input-medium date date-picker" data-date-format="dd/mm/yyyy" data-date-start-date="+0d" id="' . $id . '">
                                <input type="text" class="form-control" readonly name="' . $name . '" ' . $strAttr . '   />
                                <span class="input-group-btn">
                                    <button class="btn default" type="button">
                                        <i class="fa fa-calendar"></i>
...
function __autocomplete($fieldName, $options = array(), $attributes = array()) {
    ...
    $html .= '<div class="input-group input-medium "style="width:100% !important;">
                ...
                <button class="btn green" type="button" onclick="insertRelated('.$options['module_id'].');">
