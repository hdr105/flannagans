        ...
        <div class="pull-right">
            <div class="btn-group">
               <a class="btn"  onclick="crudBack();">   <i class="icon-arrow-left"></i>  <?php echo $lang->line('back'); ?>  &nbsp; </a>
                <a class="btn btn-danger" onclick="crudDelete('<?php echo http_build_query(array('key' => $_GET['key']), '', '&'); ?>');" > &nbsp;  <i class="icon-remove icon-white"></i>  <?php echo $lang->line('delete'); ?> &nbsp; </a>
            </div>
        </div>
                        ...
                        <div class="controls"  style="padding-top:5px;">
                            ...
                            switch ($elements[0]) {
                                ...
                                case 'file':
                                    ...
                                    if (file_exists(FCPATH . '/public/media/files/' . $value)) {
