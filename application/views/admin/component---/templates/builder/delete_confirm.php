        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-sm default"  onclick="crudBack();">   <i class="icon-arrow-left"></i>  <?php echo $lang->line('back'); ?>  &nbsp; </a>
                            <a class="btn btn btn-sm red" onclick="crudDelete('<?php echo http_build_query(array('key' => $_GET['key']), '', '&'); ?>');" > &nbsp;  <i class="icon-remove icon-white"></i>  <?php echo $lang->line('delete'); ?> &nbsp; </a>
                        </div>
            </div>
