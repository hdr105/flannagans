			...
			<div class="page-content-wrapper">
                <div class="page-content">
					...
					<?php } else if(isset($_GET['workHistory'])){ ?>					
						<form id="password-form" action="<?php echo base_url(); ?>index.php/admin/profile?workHistory" method="GET" onsubmit="return validateformdates();" enctype="multipart/form-data" class="form-horizontal">
					<?php } ?>					
							<div class="col-md-12">
								<!--START-->
								<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="pull-left">
											...
											<?php if($group_name == '2'){ ?>
												<a class="btn btn-sm  <?php if(isset($_GET['workHistory'])){ echo " blue disabled"; } else { echo "red"; }?>" href="<?php echo base_url(); ?>index.php/admin/profile?workHistory"> Working Hours History </a>
											<?php } ?>
										</div>
										<div class="pull-right">
											...
											<?php } else { ?>
												<button type="submit" class="btn btn-sm blue" name="submit"/> Save <i class="fa fa-save"></i></button>
											<?php } ?>
