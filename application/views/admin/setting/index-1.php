...
<?php $CRUD_AUTH = $this->session->userdata('CRUD_AUTH'); ?>
           ...
           <div class="page-content-wrapper">
               ...
               <div class="page-content" style="min-height:752px">
			...
			<div class="form-body">
				...
				<form accept-charset="utf-8" method="post" id="SettingSaveForm" class="form-horizontal">
					...
					<div class="panel panel-default" id="section_1">
						<div class="panel-heading">
							 <div class="panel-title">
							 	<?php echo $this->lang->line('general_options'); ?>
							 </div>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<label style="width: 90px; align:right;" for="SettingEnableSmtpAuth" class="checkbox"> 
