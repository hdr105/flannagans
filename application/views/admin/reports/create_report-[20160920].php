...
if(isset($data) and !is_null($data))
{
	...
	////// RANGE //////////////////////////////////////////////////////////
	/*$range_data = $data[0]['date_range'];
	$range_data = explode(',', $range_data);
	$rf = $range_data[0];
	$rt = $range_data[1];*/
    ...
    <option value="ny">is not empty</option>
							...
							<?php
					          ...
					          ?>
												...
												<div class="col-md-4" id="dynamic_controll_4" style="display:none;">
													<input type="text" class="simpleText
...
<script type="text/javascript">
    ...
    function saveReport(){
       ...
       ////////////////////////////////////////////////////////////////////
		...
		/*var rdfrom        = $('#cond_drange_s >input[name="range_dfrom"]').val();
		var rdto          = $('#cond_drange_s >input[name="range_dto"]').val();
		var date_range    = rdfrom+","+rdto;*/
        ...
        var jsonData = {report_name,sel_module, auto , freq , email_sent_to, cc, cc_email, related_modules, module_fields, pdfHeader , orderby , groupby , funct, conditions, custom , /*date_range ,*/ limit };
    ...
    $('.cond').on('change',function(){
        ...
        if (varVal == 'bw' && typeArr[2] == 'date') {
            ...
            var dateRange = '<div id="cond_drange_'+breakID[1]+'" class="input-group daterange input-large date-picker input-daterange" data-date="10-11-2012" data-date-format="dd-mm-yyyy"><input type="text" class="form-control" name="dfrom" required><span class="input-group-addon"> to </span><input type="text" class="form-control" name="dto" required></div>';
