							...
							<div class="tab-pane" id="tab2">
								...
								<div class="form-group">
									...
									<div class="col-md-3" style="margin-top:5px;">
										<input type="checkbox" name="rnameedit" value="" onclick="if(this.checked){showflds(); this.value=1;}else{hideflds(); this.value=0;}" id="rnameedit" class="form-control" />
									</div>
								</div>
...
<script type="text/javascript">
    ...
    function saveReport(){
       ...
       ////////////////////////////////////////////////////////////////////
        ...
        var jsonData = {report_name,sel_module, auto , freq , email_sent_to, cc, cc_email, related_modules, module_fields, pdfHeader , orderby , groupby , funct, conditions, custom};
    ...
    $('#related_modules').on('change',function(){
        ...
        $.post('<?php echo base_url(); ?>index.php/admin/reports/relatedModFieldList', {selectedModule:selectedModule, relatedModules:rm}, function(data){
            ...
            console.log("data by faheem : "+data);
	...
	$('#module_fields').on('change', function(){
		...
		if(chk_flag == "1")
		{
			...
			{
				$('#editing_alias').empty();
				var slctfld    = $('#module_fields').val();
				var module_fields = slctfld ;
