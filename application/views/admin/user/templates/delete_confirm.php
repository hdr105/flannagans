                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title">
                                                ...
                                                <div class="pull-right">
                                                    ...
                                                    <a href="javascript:;" onclick="crudDelete('<?php echo http_build_query(array('key' => $_GET['key']), '', '&'); ?>');" class="btn btn-sm default "><i class="icon-remove icon-white"></i>  <?php echo $CI->lang->line('delete');?>
                                                    </a>
                                                </div> 
                                            </div>
